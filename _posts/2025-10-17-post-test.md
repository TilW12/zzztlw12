Perfect! Here's your corrected Markdown code ready to copy and paste:
...
This is now properly formatted and ready to use! Just copy everything above and paste it into your `.md` file in your Jekyll `_posts` folder.